...
#ifndef INCLUDE_TASKS_CONSOLE_TASK_H_
#define INCLUDE_TASKS_CONSOLE_TASK_H_
 ...
 * Macros
 ******************************************************************************/
extern volatile bool exit_task;

/*******************************************************************************
 * Macros
 ******************************************************************************/
#define CONSOLE_TASK_NAME               "console_task"
#define CONSOLE_TASK_STACK_SIZE         (configMINIMAL_STACK_SIZE * 2)
#define CONSOLE_TASK_PRIORITY           (configMAX_PRIORITIES - 3)
...
/* Callback function called from app_bt_gatt_handler when SensorEnable message received */
void console_task_ble_app_callback();

#endif /* INCLUDE_TASKS_CONSOLE_TASK_H_ */
